...
import 'package:panuncialman_todo/data/model/task.dart';
import 'package:panuncialman_todo/utils/extensions.dart';
import 'package:panuncialman_todo/widgets/circle_container.dart';
        ...
        children: [
          ...
          Visibility(
            ...
            child: Row(
              ...
              children: [
                Text('Task nga buhatonon inig ka ${task.date}'),
